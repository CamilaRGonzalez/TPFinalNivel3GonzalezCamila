<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GestionMarcas.aspx.cs" Inherits="TiendaOnline.GestionMarcas" %>
           ...
           <!--TARJETA CONTENEDORA-->
            <div class="card border-0 m-4" style="margin-top:20px;">
                <div class="card-header border">
                    <i class="fas fa-table me-1"></i> Marcas
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content bg-light">
                        ...
                        <div class="modal-body">
                            ...
                            <asp:Label Text="" ID="lblError" CssClass="lblError mt-2" ForeColor="Red" runat="server" />
                        </div>
